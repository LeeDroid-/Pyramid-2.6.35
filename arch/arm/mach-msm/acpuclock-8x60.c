...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	[0]  = { MAX_AXI, 0, 0,    875000, 912500, 0},
	[1]  = { 432000,  1, 0x08, 875000, 912500, 0},
	[2]  = { 486000,  1, 0x09, 887500, 925000, 0},
	[3]  = { 540000,  1, 0x0A, 912500, 937500, 0},
	[4]  = { 594000,  1, 0x0B, 925000, 950000, 0},
	[5]  = { 648000,  1, 0x0C, 937500, 975000, 1},
	[6]  = { 702000,  1, 0x0D, 950000, 1000000, 1},
	[7]  = { 756000,  1, 0x0E, 975000, 1012500, 1},
	[8]  = { 810000,  1, 0x0F, 1000000, 1037500, 1},
	[9]  = { 864000,  1, 0x10, 1012500, 1062500, 1},
	[10] = { 918000,  1, 0x11, 1037500, 1097500, 2},
	[11] = { 972000,  1, 0x12, 1062500, 1125000, 2},
	[12] = {1026000,  1, 0x13, 1097500, 1137500, 2},
	[13] = {1080000,  1, 0x14, 1125000, 1162500, 2},
	[14] = {1134000,  1, 0x15, 1137500, 1187500, 2},
	[15] = {1188000,  1, 0x16, 1162500, 1200000, 3},
	[16] = {1242000,  1, 0x17, 1187500, 1212500, 3},
	[17] = {1296000,  1, 0x18, 1200000, 1225000, 3},
	[18] = {1350000,  1, 0x19, 1212500, 1225000, 3},
	[19] = {1404000,  1, 0x1A, 1225000, 1237500, 3},
	[20] = {1458000,  1, 0x1B, 1237500, 1250000, 3},
	[21] = {1512000,  1, 0x1C, 1250000, 1262500, 3},
	[22] = {1566000,  1, 0x1D, 1262500, 1275000, 3},
	[23] = {1620000,  1, 0x1E, 1275000, 1287500, 3},
	[24] = {1674000,  1, 0x1F, 1287500, 1300000, 3},
	[25] = {1728000,  1, 0x20, 1300000, 1312500, 3},
	[26] = {1782000,  1, 0x21, 1312500, 1325000, 3},
	[27] = {1836000,  1, 0x22, 1325000, 1375000, 3},
};

#define L2(x) (&l2_freq_tbl_v2[(x)])
/* SCPLL frequencies = 2 * 27 MHz * L_VAL */
static struct clkctl_acpu_speed acpu_freq_tbl_v2[] = {
  { {1, 1},  270000,  ACPU_PLL_8, 3, 1, 0, 0,    L2(1),   812500, 0x03006000},
  ...
  { {1, 1}, 1620000,  ACPU_SCPLL, 0, 0, 1, 0x1E, L2(23), 1287500, 0x03006000},
  { {1, 1}, 1674000,  ACPU_SCPLL, 0, 0, 1, 0x1F, L2(24), 1300000, 0x03006000},
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(25), 1312500, 0x03006000},
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(26), 1325000, 0x03006000},
  { {1, 1}, 1836000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(27), 1337500, 0x03006000},
  { {0, 0}, 0 },
};
