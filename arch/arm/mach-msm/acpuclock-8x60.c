...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[23] = {1620000,  1, 0x1E, 1250000, 1300000, 3},
	[24] = {1647000,  1, 0x1F, 1250000, 1300000, 3},
	[25] = {1728000,  1, 0x20, 1275000, 1325000, 3},
	[26] = {1782000,  1, 0x21, 1275000, 1325000, 3},
	[27] = {1836000,  1, 0x22, 1300000, 1350000, 3},
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_v2[] = {
  ...
  { {1, 1}, 1566000,  ACPU_SCPLL, 0, 0, 1, 0x1D, L2(20), 1262500, 0x03006000},
  { {1, 1}, 1620000,  ACPU_SCPLL, 0, 0, 1, 0x1E, L2(20), 1275000, 0x03006000},
  { {1, 1}, 1674000,  ACPU_SCPLL, 0, 0, 1, 0x1F, L2(20), 1287500, 0x03006000},
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(21), 1300000, 0x03006000},
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(21), 1312500, 0x03006000},
