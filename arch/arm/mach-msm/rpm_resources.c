...
static void msm_rpmrs_aggregate_rpm_cpu(struct msm_rpmrs_limits *limits, int from_idle);
...
void msm_rpmrs_exit_sleep(struct msm_rpmrs_limits *limits, int from_idle)
{
	if (container_of(limits, struct msm_rpmrs_level, rs_limits)->use_mpm)
